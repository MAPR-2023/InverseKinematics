...
namespace DitzelGames.FastIK
{
    ...
    public class FastIKFabric : MonoBehaviour
    {
        ...
        private void ResolveIK()
        {
            ...
            this.targetProjectedToFloor = Vector3.ProjectOnPlane(Target.position, Vector3.up).normalized;
        ...
        {
            Vector3 ShoulderSegmentVector = Bones[1].position; // - Vector3.zero
            ...
            if (previousAnglesData != anglesData && sendingMessages)
            {
                braccioController.SendSerialMessage(anglesData);
                //Debug.Log("Base: " + BaseRotation + " Shoulder: " + ShoulderRotation + " Elbow: " + ElbowRotation + " Wrist: " + WristRotation);
            }
        ...
        void OnDrawGizmos()
        {
            ...
            Handles.DrawSolidArc(Vector3.zero, Vector3.up, Vector3.right, 315, 2);
            ...
            for (int i = 0; i < ChainLength && current != null && current.parent != null; i++)
            {
                ...
                Handles.DrawSolidArc(new Vector3(0, currentParentDistance, 0), Vector3.Cross(Vector3.up, Vector3.left), Vector3.down, MinAngles[i],  2);

                // Draw Max Angle
                Handles.color = Color.magenta;
                Handles.DrawSolidArc(new Vector3(0, currentParentDistance, 0), Vector3.Cross(Vector3.down, Vector3.right), Vector3.down, MaxAngles[i], 2);
                current = current.parent;
            }
#endif
        }
